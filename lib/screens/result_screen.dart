...
class _ResultScreenState extends State<ResultScreen> {
  ...
  void initState() {
    ...
    _initData();
    // When the screen is left, ensure the YouTube player is hidden
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<YouTubeService>().hidePlayer();
    });
  }
  ...
  void _calculateTopEmotions() {
    ...
    // Update Character and Theme
    if (_top3Emotions.isNotEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        final characterProvider = Provider.of<CharacterProvider>(context, listen: false);
        final themeNotifier = Provider.of<ThemeNotifier>(context, listen: false);
        
        characterProvider.setEmotions(_top3Emotions);
        themeNotifier.setTheme(characterProvider.getCharacterTheme());
      });
    }
  }
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const SizedBox(height: 80), // Added spacing to push content down
              GlassCard(
                child: Column(
                  children: [
                    ClipRRect(
                      ...
                      child: TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => AllEmotionsScreen(
            ...
            Consumer<YouTubeService>(
              builder: (context, youtubeService, child) {
                if (youtubeService.isPlayerVisible && youtubeService.controller != null) {
                  return Card(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  youtubeService.selectedVideo?.title ?? 'Now Playing',
                  ...
                  return Column(
                    children: [
                      ...
                      EmotionCharacterCard(
                        ...
                        size: 200,
                        accessoryEmotions: _top3Emotions,
                      ),
                    ],
                  );
                },
